...
const zhCn: MessageBundle = {
  ...
  'extension.playbackControlsTitle': 'AudioPlugin 播放控制',
  'extension.pauseResumeItem': '$(debug-pause) 暂停 / 恢复播放',
  'extension.stopItem': '$(debug-stop) 停止播放',
  'extension.firstRunNoApiKey': 'AudioPlugin 朗读助手：尚未设置语音合成密钥，是否现在设置？',
...
const en: MessageBundle = {
  ...
  'extension.playbackControlsTitle': 'AudioPlugin Playback Controls',
  'extension.pauseResumeItem': '$(debug-pause) Pause / Resume',
  'extension.stopItem': '$(debug-stop) Stop Playback',
  'extension.firstRunNoApiKey': 'AudioPlugin Reader: TTS API key is not set yet. Set it now?',
