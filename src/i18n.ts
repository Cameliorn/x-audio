...
const zhCn: MessageBundle = {
    ...
    'roleAnalysis.copilotNotConfigured': '尚未在 Copilot 中选择角色分析模型。请先运行“MiniMax 文字转语音：配置角色分析”。',
...
const en: MessageBundle = {
    ...
    'roleAnalysis.copilotNotConfigured': 'No Copilot model selected for role analysis. Run "MiniMax TTS: Configure Role Analysis" first.',
